  ...
  return (
    <section className={styles["about"]}>
      <div className={styles["about-container"]}>
        <h2 className={styles["about-title-h2"]}>Познайомимося?</h2>
        <p className={styles["about-text"]}>
          Світ штучного інтелекту відкриває безмежні можливості – і ми тут, щоб
          провести вас у цей захопливий світ. Ми створили B1ONE для тих, хто
          хоче розібратися в AI, налаштувати його під свої потреби та
